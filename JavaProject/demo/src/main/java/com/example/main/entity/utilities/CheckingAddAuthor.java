...
public final class CheckingAddAuthor {
    ...
    /**
     *
     * @param author принимает экземпляр автора для проверки правильности заполнения полей.
     *               Детали:
     *               Парсим
     ...
     *
     * @return возвращает экземпляр класса Author поля которого были проверенны и отформатированны.
     */
